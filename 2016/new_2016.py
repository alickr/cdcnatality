...
file = open('./csv/Nat2016us_v2.csv', 'w', encoding='utf-8', newline='')
...
output.writerow(['DOB_YY','DOB_MM' ,'DOB_TT', 'DOB_WK', 'BFACIL', 'F_FACILITY','BFACIL3', 'MAGE_IMPFLG', \
    ...
    'FRACEHISP', 'FEDUC', 'PRIORLIVE', 'PRIORDEAD', 'PRIORTERM', 'LBO_REC', 'TBO_REC', 'ILLB_R', \
...
for item in f.readlines():
    ...
    # df['FHISPX'] = item[158:159] # does not exist in 2016
    df['FBRACE'] = item[155:156] #missing in 2018
    df['FHISP_R'] = item[159:160]
    df['F_FHISP'] = item[160:161]
    df['FRACEHISP'] = item[161:162]
    df['FEDUC'] = item[162:163]
    # df['f_FEDUC'] = item[164:165] #does not exist

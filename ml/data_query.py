...
# Random Forests
%time random_forest_model, x_train1, x_test1, y_train1, y_test1 = modeling.random_forest(x, y,class_weight={0:1,1:10},)  # create model and fit # class_weight="balanced"
...
modeling.get_normalized_confusion_matrix(random_forest_model, x_test1, y_test1)  # print Normalized confusion matrix
...
modeling.get_normalized_confusion_matrix(xgb_model, x_test3, y_test3)  # print Normalized confusion matrix

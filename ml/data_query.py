...
random_forest_model.get_params,random_forest_model.feature_importances_

important_features = pd.Series(data=random_forest_model.feature_importances_,index=x.columns)
